...
<table cellpadding="10" cellspacing="0" class="table table-striped">
        <tr>
            ...
            <td widht="200px" class="text-center">Telpon</td>
        ...
        <tr>
            ...
            <td><?php echo $pengarang['nama_pengarang'] ?></td>
            <td><?php echo $pengarang['email'] ?></td>
            <td><?php echo $pengarang['telp'] ?></td>
            <td><?php echo $pengarang['alamat'] ?></td>
            <td>
